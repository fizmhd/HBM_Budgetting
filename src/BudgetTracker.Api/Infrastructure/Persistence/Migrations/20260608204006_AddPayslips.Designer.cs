...
namespace BudgetTracker.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260608204006_AddPayslips")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetTracker.Api.Infrastructure.Persistence.Entities.Payslip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PersonnummerEncrypted")
                        .HasMaxLength(1024)
                        .HasColumnType("character varying(1024)");

                    b.Property<string>("PersonnummerMasked")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<Guid?>("PostedAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("HouseholdId")
                        .HasDatabaseName("IX_Payslips_HouseholdId");

                    b.HasIndex("OwnerUserId")
                        .HasDatabaseName("IX_Payslips_OwnerUserId");

                    b.HasIndex("OwnerUserId", "PayDate")
                        .HasDatabaseName("IX_Payslips_OwnerUserId_PayDate");

                    b.ToTable("Payslips", (string)null);
                });

            modelBuilder.Entity("BudgetTracker.Api.Infrastructure.Persistence.Entities.PayslipLeaveBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PayslipId")
                        .HasDatabaseName("IX_PayslipLeaveBalances_PayslipId");

                    b.ToTable("PayslipLeaveBalances", (string)null);
                });

            modelBuilder.Entity("BudgetTracker.Api.Infrastructure.Persistence.Entities.PayslipLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PayslipId")
                        .HasDatabaseName("IX_PayslipLineItems_PayslipId");
            ...
            modelBuilder.Entity("BudgetTracker.Api.Infrastructure.Persistence.Entities.PayslipLeaveBalance", b =>
                {
                    b.HasOne("BudgetTracker.Api.Infrastructure.Persistence.Entities.Payslip", null)
